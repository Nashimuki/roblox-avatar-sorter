...
This extension will *NEVER* delete an avatar if it wasn't first created, so if get an error, your avatars will still be available.

As of now, if you have avatars with custom skin colors (colors that Roblox does not provide by default and are added through hex code), I advise against using this extension.
When reordering the avatars, it will change custom colors to the nearest available color provided by Roblox.
